...
import { getAuth, GoogleAuthProvider, signInWithPopup, signOut, onAuthStateChanged, User, signInAnonymously, setPersistence, browserLocalPersistence } from 'firebase/auth';
...
// Set session persistence so the session is kept across tab closes
